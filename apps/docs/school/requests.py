...
REQUEST_SCHOOL_CREATE = openapi.Schema(
            ...
            properties={
                ...
                'address': openapi.Schema(type=openapi.TYPE_OBJECT,description='Endereço da escola'),
...
REQUEST_SCHOOL_UPDATE = openapi.Schema(
    ...
    properties={
        ...
        "address": openapi.Schema(type=openapi.TYPE_OBJECT,description="O endereço da escola"),
